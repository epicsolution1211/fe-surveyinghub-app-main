...
const CreateAccount = (props: { signinLink: string }) => {
    ...
    const registerUser: () => void = async () => {
        ...
        if (password !== passwordValidation) {
            setInfoMessage({
                type: "error",
                text: "Passwords mismatch, please retry.",
            });
            return;
        }
    ...
    return (<>
            ...
            <form onSubmit={(e) => {
                ...
                <div className="w-full">
                    ...
                    <div className="my-5 text-left">
                        <label className="p-0 m-0 text-[14px] inline-flex cursor-pointer text-black/85 align-baseline">
                            <input type="checkbox" className="cursor-pointer" checked={agreements}
                                   onChange={(e) => {
                                       setAgreements(e.target.checked);
                                   }}/>
                            <div
                                className={`px-[8px] text-[14px] ml-1 font-normal text-light-white ${agreements ? "text-white" : "text-light-white"}`}>
                    ...
                    <div className="mt-3.5 md:mt-4">
                        <Button
                            ...
                            padding="width"
                            type={agreements ? 'primary' : 'disabled'}
                            onClick="submit"/>
                    </div>
                </div>
            </form>
            ...
            <div className="w-full card-width px-0 pb-6 md:pb-16 mx-auto">
                <Button
                    label="Already have an account? Login" type="secondary" padding="width"
                    onClick={props.signinLink}/>
            </div>
            {/*                            <div className="mt-3.5 md:mt-4">
                                <Button
